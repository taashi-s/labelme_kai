...
class LabelDialog(QtWidgets.QDialog):
    ...
    def __init__(self, text="Enter object label", parent=None, labels=None,
        ...
        self.edit.setValidator(labelme_kai.utils.labelValidator())
        ...
        bb.button(bb.Ok).setIcon(labelme_kai.utils.newIcon('done'))
        bb.button(bb.Cancel).setIcon(labelme_kai.utils.newIcon('undo'))
