...
from labelme_kai import QT5
from labelme_kai.shape import Shape
...
class Canvas(QtWidgets.QWidget):
    ...
    def boundedMoveShapes(self, shapes, pos):
        ...
        if self.outOfPixmap(o2):
            pos += QtCore.QPoint(int(min(0, self.pixmap.width() - o2.x())),
    ...
    def boundedShiftShapes(self, shapes):
        ...
        point = shapes[0][0]
        offset = QtCore.QPoint(int(2.0), int(2.0))
        self.offsets = QtCore.QPoint(), QtCore.QPoint()
    ...
    def closeEnough(self, p1, p2):
        ...
        return labelme_kai.utils.distance(p1 - p2) < (self.epsilon / self.scale)
    ...
    def intersectingEdges(self, point1, point2, points):
        ...
        for i in range(4):
            ...
            if 0 <= ua <= 1 and 0 <= ub <= 1:
                ...
                d = labelme_kai.utils.distance(m - QtCore.QPoint(int(x2), int(y2)))
                yield d, i, (x, y)
