...
from labelme_kai import __appname__
from labelme_kai import __version__
from labelme_kai.app import MainWindow
from labelme_kai.config import get_config
from labelme_kai.logger import logger
from labelme_kai.utils import newIcon
...
def main():
    ...
    default_config_file = os.path.join(os.path.expanduser('~'), '.labelme_kairc')
    parser.add_argument(
        '--config',
        dest='config_file',
